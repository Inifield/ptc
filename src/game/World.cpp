...
void World::LoadConfigSettings(bool reload)
{
    ...
    rate_values[RATE_CREATURE_NORMAL_DAMAGE_MIN]          = sConfig.GetFloatDefault("Rate.Creature.Normal.Damage.Min", 1.0f);
    rate_values[RATE_CREATURE_ELITE_ELITE_DAMAGE_MIN]     = sConfig.GetFloatDefault("Rate.Creature.Elite.Elite.Damage.Min", 1.0f);
    rate_values[RATE_CREATURE_ELITE_RAREELITE_DAMAGE_MIN] = sConfig.GetFloatDefault("Rate.Creature.Elite.RAREELITE.Damage.Min", 1.0f);
    rate_values[RATE_CREATURE_ELITE_WORLDBOSS_DAMAGE_MIN] = sConfig.GetFloatDefault("Rate.Creature.Elite.WORLDBOSS.Damage.Min", 1.0f);
    rate_values[RATE_CREATURE_ELITE_RARE_DAMAGE_MIN]      = sConfig.GetFloatDefault("Rate.Creature.Elite.RARE.Damage.Min", 1.0f);
    rate_values[RATE_CREATURE_NORMAL_DAMAGE_MAX] = sConfig.GetFloatDefault("Rate.Creature.Normal.Damage.Max", 1.0f);
    rate_values[RATE_CREATURE_ELITE_ELITE_DAMAGE_MAX] = sConfig.GetFloatDefault("Rate.Creature.Elite.Elite.Damage.Max", 1.0f);
    rate_values[RATE_CREATURE_ELITE_RAREELITE_DAMAGE_MAX] = sConfig.GetFloatDefault("Rate.Creature.Elite.RAREELITE.Damage.Max", 1.0f);
    rate_values[RATE_CREATURE_ELITE_WORLDBOSS_DAMAGE_MAX] = sConfig.GetFloatDefault("Rate.Creature.Elite.WORLDBOSS.Damage.Max", 1.0f);
    rate_values[RATE_CREATURE_ELITE_RARE_DAMAGE_MAX] = sConfig.GetFloatDefault("Rate.Creature.Elite.RARE.Damage.Max", 1.0f);
    ...
    m_configs[CONFIG_DONT_CACHE_RANDOM_MOVEMENT_PATHS] = sConfig.GetBoolDefault("DontCacheRandomMovementPaths", true); // pussywizard
